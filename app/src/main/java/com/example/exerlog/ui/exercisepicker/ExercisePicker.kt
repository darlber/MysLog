...
//import com.example.exerlog.ui.exercisepicker.components.ExerciseCard
...
//import com.example.exerlog.ui.theme.onlyTop
//import com.example.exerlog.utils.UiEvent
//import com.example.exerlog.utils.clearFocusOnKeyboardDismiss
                ...
                Surface(
                    ...
                    Column {
                        ...
                        TextField(
                            ...
                            onValueChange = { viewModel.onEvent(ExerciseEvent.SearchChanged(it)) },
                            modifier = Modifier
                                .fillMaxWidth()
                        ...
                        Row(
                            ...
                            FilterChip(
                                ...
                                onClick = { viewModel.onEvent(ExerciseEvent.FilterSelected) },
                                label = {
                                    Text(text = "Selected")
                                },
                                colors = filterColors
                            ...
                            FilterChip(
                                selected = filterUsed,
                                onClick = { viewModel.onEvent(ExerciseEvent.FilterUsed) },
                                label = {
                                    Text(text = "Used")
                                },
                                colors = filterColors
